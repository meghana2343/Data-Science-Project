...
This repository explores **Stock Price Prediction** using multiple **Machine Learning** and **Deep Learning** algorithms — including Linear Regression, Random Forest, LSTM.  

The project demonstrates how deep learning models, outperform traditional approaches in capturing sequential dependencies in time-series financial data.
